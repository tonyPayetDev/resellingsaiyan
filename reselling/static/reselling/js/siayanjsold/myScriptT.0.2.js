            ...
            $('#'+id+' tbody').on('click', 'tr', function () {
                ...
                $.each(jsonautre.field, function (key, data) {
                    ...
                    $.each(data, function (index, data) {
                        ...
                        tabTransf=reconstructionOptForaDatatable(id,data);
                ...
                function get_telco(idclick,nameList)
                {
                ...
                function reconstructionOptForaDatatable(tab,list){
